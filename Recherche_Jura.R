...
IDs_Session_Elus <- if (nrow(Geschaefte_Elus) > 0) unique(Geschaefte_Elus$ID) else c()
IDs_Session_All <- unique(c(IDs_Session_DE, IDs_Session_FR, IDs_Session_Elus))
...
Tous_Geschaefte <- bind_rows(Geschaefte_DE, Geschaefte_FR, Geschaefte_Elus, Geschaefte_Commission_DE, Geschaefte_Commission_FR)
